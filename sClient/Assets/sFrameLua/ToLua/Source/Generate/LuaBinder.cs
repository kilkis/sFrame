...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		System_Collections_Generic_Dictionary_ulong_sAvatarListWrap.Register(L);
		System_Collections_Generic_KeyValuePair_ulong_sAvatarListWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
		L.EndModule();
