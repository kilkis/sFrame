...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(sULoading)),
        _GT(typeof(sGameFlow)),
        _GT(typeof(sNetworkInterface)),
        _GT(typeof(sAvatarList)),
        _GT(typeof(Dictionary<UInt64, sAvatarList>)).SetLibName("AccountMap"),
        _GT(typeof(KeyValuePair<UInt64, sAvatarList>)),  
    };
