...
public class sBuildAssetbundle
{
	...
	/// </summary>
    [MenuItem("sFramework/第一步.ClearAssetBundlesName~清除所有资源名称")]
    ...
    [MenuItem("sFramework/第二步.Build AssetBundle~随游戏资源准备")]
    ...
    [MenuItem("sFramework/第三步.Build Lua~打包Lua")]
    ...
    [MenuItem("sFramework/第四步.Build Avatar~打包Avatar和其他资源(请选择sAvatar目录)")]
    ...
    [MenuItem("sFramework/第五步.Copy Bin File")]
    static void CopyBin()
    {
    ...
    [MenuItem("sFramework/-----------分隔线-NavMesh--------------")]
    static void fgxs()
    { }

    [MenuItem("sFramework/打包NavMesh(需点选目录)")]
    ...
    [MenuItem("sFramework/-----------分隔线-Shader--------------")]
    static void fgxss()
    { }

    [MenuItem("sFramework/打包Shader")]
    ...
    [MenuItem("sFramework/Zip Update~压缩更新文件")]
    ...
    static void file3(string source)
    {
        ...
        AssetImporter assetImporter = AssetImporter.GetAtPath(source);
        string assetName = source.Substring(source.IndexOf("/") + 1);
        assetName = assetName.Replace(Path.GetExtension(assetName), ".sab");
        //Debug.Log (assetName);
        string[] tmp = source.Split('.');
        if (tmp[1] == "shader")
    ...
    [MenuItem("sFramework/-----------分隔线2--------------")]
    static void fgx2()
    { }
    [MenuItem("sFramework/!~Clear All AssetBundle")]
    ...
    [MenuItem("sFramework/!~Clear All Update AssetBundle")]
    ...
    [MenuItem("sFramework/RefreshMat")]
